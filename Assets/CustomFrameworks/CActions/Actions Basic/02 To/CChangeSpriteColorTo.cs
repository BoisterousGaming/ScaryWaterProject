...
{
	public class CChangeSpriteColorTo : CAction
	{
		SpriteRenderer _Target = null;
		...
		static public CChangeSpriteColorTo ChangeColor(SpriteRenderer spriteRenderer, Color endColor,float duration)
		{
			CChangeSpriteColorTo tChange = new CChangeSpriteColorTo();
			tChange.actionWith(spriteRenderer,endColor,duration);
			return tChange;
		}
		
		protected void actionWith(SpriteRenderer spriteRenderer, Color endColor,float duration)
		{
