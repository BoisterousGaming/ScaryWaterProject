...
public class CAmbientSFX : MonoBehaviour {

    static CAmbientSFX mInstance;

    public AudioSource _AudioSource;
    Hashtable mClipTable = new Hashtable();
    string mStorageName = "AmbientSFX";
    string mCurrentAudioClip = "";
    float mfVolume = 1;
    bool mbMute = false;

    //Get singleton of Music Player
    public static CAmbientSFX Instance
    {
        get
        {
            if (mInstance == null)
            {
                ...
                tObj.name = "AmbientSFX";
                mInstance = tObj.AddComponent<CAmbientSFX>();
